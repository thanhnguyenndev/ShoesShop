/*$(document).ready(function () {
  ...
  let errcheckEmail = $("#check__email ~ .error");
  ...
  checkEmail.focusout(function () {
    ...
    if (str.length < 1) {
      errcheckEmail.show();
      return (errcheckEmailBool = true);
    }

    errcheckEmail.hide();
    errcheckEmailBool = false;
  });
