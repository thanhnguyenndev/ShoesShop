		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<a href="${base }/admin/detail-contact/${contactEntity.id}"
									class="btn btn-primary" data-toggle="modal"
									data-target="#exampleModal">View Detail <i
										class="fas fa-eye" style="margin-left: 5px"></i>
								</a> <a href="${base }/admin/delete-contact/${contactEntity.id}"
					...
					<a class="btn btn-primary" href="${base }/admin/list-contact">Back
						To List</a>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h2 class="modal-title" id="exampleModalLabel" align="center">Chi
										tiết</h2>
